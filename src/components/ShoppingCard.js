...
function ShoppingCard({ product, addToCart }) {
  return (
    <div className="md:w-[292px] md:h-[538px] border border-[#AC702F] py-2 px-4 rounded-lg flex flex-col justify-between">
      ...
      <div>
        ...
        <h5 className="md:text-sm text-xs text-gray-500 mt-5">
          <span className="font-bold text-[#AC702F]">{product.stock}</span> left
          in stock
        </h5>
      </div>
